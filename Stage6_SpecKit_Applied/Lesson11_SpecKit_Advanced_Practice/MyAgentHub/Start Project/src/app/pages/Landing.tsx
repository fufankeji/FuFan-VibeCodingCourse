...
export default function Landing() {
  return (
    <div className="flex flex-col">
      ...
      <section className="relative flex max-h-[60vh] flex-col items-center justify-center px-[24px] py-[48px] text-center md:py-[64px]">
        ...
        <div className="mx-auto max-w-[1280px]">
          <div className="mb-[24px] flex items-end justify-between">
            ...
            <Button variant="ghost" asChild>
              <Link to="/gallery">查看全部 <ArrowRight className="ml-[4px] h-[16px] w-[16px]" /></Link>
            </Button>
          </div>
